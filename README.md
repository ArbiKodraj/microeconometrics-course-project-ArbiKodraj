...
- 1. Introduction: There, the author's question and it political relevance will be introduced  
...
- 5. Results: Here, I am going to replicate all results and extend them by further analysis and methods in order to check their robustness
